...
const events = [
  {
    year: "2025",
    title: "Сотрудничество с зарубежной компанией",
    description: "Создание с нуля маркетплейса для ботов с возможностью внедрения в сторонние системы. Fullstack-разработка, архитектура, интеграции.",
  },
  {
    year: "2025",
